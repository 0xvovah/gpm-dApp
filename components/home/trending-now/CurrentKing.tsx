...
export default function CurrentKing({ tokenInfo }: { tokenInfo: any }) {
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      <div className="flex justify-center items-center gap-2">
        ...
        />
        <div className="text-cyan-300 text-lg font-bold">current king</div>
        <Image
          src={icons.crown}
          width={0}
          height={0}
      ...
      <div
        className="flex flex-col flex-1 justify-center items-center cursor-pointer bg-black rounded-lg"
        ref={ref}
        onClick={onViewCoin}
      >
        <div
